...
function nextClickingFunction(){
  console.log("CLICKING");
  incSong();
  loadAndPlayCurrentSong();
}

function previousClickingFunction(){
  console.log("CLICKING");
  decSong();
  loadAndPlayCurrentSong();
}
...
nextBtn.onclick = nextClickingFunction;

let previousBtn = document.getElementById('previous-button');
previousBtn.onclick = previousClickingFunction;

let pauseBtn = document.getElementById('pause-button');
pauseBtn.onclick = pauseButton;
